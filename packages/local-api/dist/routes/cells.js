    ...
    router.get("/cells", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 6]);
                    return [4 /*yield*/, promises_1.default.readFile(filePath, { encoding: encoding })];
                case 1:
                    fileContent = _a.sent();
                ...
                case 2:
                    ...
                    // Create a file
                    return [4 /*yield*/, promises_1.default.writeFile(filePath, "[]", encoding)];
                case 3:
                    // Create a file
                    _a.sent();
                    res.send([]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promises_1.default.writeFile(filePath, JSON.stringify(cells), encoding)];
                case 1:
                    _a.sent();
                    res.send({ status: "ok" });
                    return [2 /*return*/];
